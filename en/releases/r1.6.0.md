...
## [Throttle control #45](https://github.com/actframework/actframework/issues/435)

Now the framework has built-in throttle control support to prevent DoS attack

### Throttle controle on request handler
...
### Throttle control in route table
...
## [Support webjars](https://github.com/actframework/actframework/issues/331)
